...
<p style="text-indent: 0.2cm; margin-bottom: 0.1cm; text-transform: uppercase; line-height: 100%; text-decoration: none;"><span style="background: transparent;"> <a class="western" href="#__RefHeading___Toc3089_1012792670"> 5.2 REACHES SHAPE </a> </span></p>
...
<ul>
<li class="western">Save the file <span style="background: transparent;">(ex.: </span><strong><span style="background: transparent;">Reaches</span></strong><span style="background: transparent;">) </span>using a Coordinate Reference System (CRS) in UTM (Universal Transverse de Mercator) projection type for the local meridian strip.</li>
...
<li class="western">It is not necessary to create any field when creating the shapefile <strong>Reaches</strong>.</li>
</ul>
</li>
